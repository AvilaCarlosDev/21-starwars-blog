...
export default function PlanetDetail() {
  ...
  const isFav = store.favorites.some(f => f.uid === id && f.type === 'planet');
  ...
  const toggle = () => {
    const payload = { uid: id, type: 'planet', name: details?.name || id };
        ...
        <div className="row">
          <div className="col-md-4">
            <img
              ...
              alt={details.name}
              onError={(e) => { e.target.src = 'https://via.placeholder.com/400x400?text=Planet'; }}
            />
          </div>
